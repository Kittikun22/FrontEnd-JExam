...
function ExamNewList({ newestExam, myFavExam, onClickFavExam, onUnFavExam, myExamList, onAddToCart }) {
    ...
    return (
        <>
            <Box>
                <Typography variant='h4' align='center'>ใหม่ล่าสุด</Typography>
            </Box>
            <Box
