    ...
    return (
        ...
        <>
            <Box mb={10}>
                ...
                <Typography mt={4} sx={{ fontSize: '3rem', textAlign: 'center', color: 'black' }}>J Knowledge Shop</Typography>
                <Box>
                    <Flickity
                        ...
                        {shopList.map((val, key) => {
                            return (
                                <Box sx={{ mx: 2 }} key={key} className='shop-cell'>
                                    <Card sx={{ borderRadius: 10, border: 5, borderColor: 'white' }}>
                                        <CardActionArea
                                            component={Link}
                                            target="_blank"
                        ...
                        <Card sx={{ width: '240px' }}>
                            ...
                            <CardActions>
                                <Button
                                    ...
                                    fullWidth
                                    target="_blank"
                                    sx={{ background: "#015352" }} color="primary"
                                    href="https://jknowledgetutor.com/featured_item/%e0%b8%ab%e0%b8%99%e0%b8%b1%e0%b8%87%e0%b8%aa%e0%b8%b7%e0%b8%ad%e0%b8%aa%e0%b8%a3%e0%b8%b8%e0%b8%9b%e0%b9%80%e0%b8%99%e0%b8%b7%e0%b9%89%e0%b8%ad%e0%b8%ab%e0%b8%b2-%e0%b8%a1-%e0%b8%9b%e0%b8%a5%e0%b8%b2/">
                                    สั่งซื้อ
                                </Button>
                            </CardActions>
                        ...
                        <Card sx={{ width: '240px' }}>
                            ...
                            >
                                ...
                                <CardContent>
                                    ...
                                    >
                                        หนังสือเตรียมสอบ แพทย์-ทันตะ TCAS65-66 ฟรี! คอร์สติวความถนัดแพทย์(กสพท.)
                                    </Typography>
                                </CardContent>
                            </CardActionArea>
                            <CardActions>
