...
function Exam() {
  ...
  const ALEVELExams = allExam?.filter(
    (item) => item.category_name === "A-LEVEL"
  );
  const TGATExams = allExam?.filter((item) => item.category_name === "TGAT");
  const TPATExams = allExam?.filter((item) => item.category_name === "TPAT");
  const NETSATExams = allExam?.filter(
    (item) => item.category_name === "NETSAT"
  );
  ...
  return (
    <>
      ...
      <AddExamContent
        openAddExamContent={openAddExamContent}
        setOpenAddExamContent={setOpenAddExamContent}
        selectExam={selectExam}
        setSelectExam={setSelectExam}
      />
      <AddExamInfo
        openAddExamInfo={openAddExamInfo}
        setOpenAddExamInfo={setOpenAddExamInfo}
        selectExam={selectExam}
        setSelectExam={setSelectExam}
      />
      <AddBluePrint
        openAddBluePrint={openAddBluePrint}
        setOpenAddBluePrint={setOpenAddBluePrint}
        selectExam={selectExam}
        ...
        >
          ...
          <ButtonGroup variant="outlined" size="large">
            ...
            <Button
              ...
              onClick={() => setFilterExam("netsat-exam")}
            >
              NETSAT({NETSATExams?.length})
            </Button>
            <Button
              sx={{
              ...
              onClick={() => setFilterExam("tgat-exam")}
            >
              TGAT({TGATExams?.length})
            </Button>
            <Button
              sx={{
              ...
              onClick={() => setFilterExam("tpat-exam")}
            >
              TPAT({TPATExams?.length})
            </Button>
            <Button
              sx={{
              ...
              onClick={() => setFilterExam("alevel-exam")}
            >
              A-LEVEL({ALEVELExams?.length})
            </Button>
          </ButtonGroup>
